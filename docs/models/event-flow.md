...
| FeePolicyChangedEvent | club/fee | `src/main/java/com/official/lockr/domain/club/fee/domain/event/FeePolicyChangedEvent.java` |
| FeeRecordMarkedPaidEvent | club/fee | `src/main/java/com/official/lockr/domain/club/fee/domain/event/FeeRecordMarkedPaidEvent.java` |
| UnpaidFeeNotifiedEvent | club/fee | `src/main/java/com/official/lockr/domain/club/fee/domain/event/UnpaidFeeNotifiedEvent.java` |
