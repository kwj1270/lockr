...
public class Bench {
    ...
    public Bench(final List<BenchPlayer> benchPlayers) {
        this.benchPlayers = benchPlayers;
    }

    public static Bench of(final List<Player> entryPlayers) {
        return new Bench(entryPlayers.stream()
                .filter(Player::isSubstitute)
