package com.official.lockr.domain.game.match.api;

import com.official.lockr.domain.auth.domain.auth.SignInSession;
import com.official.lockr.domain.game.match.api.dto.AcceptMatchRequest;
import com.official.lockr.domain.game.match.api.dto.InviteMatchRequest;
import com.official.lockr.domain.game.match.application.AcceptMatchUseCase;
import com.official.lockr.domain.game.match.application.InviteMatchUseCase;
...
public class MatchApi {
    ...
    public ResponseEntity<Match> invite(
        ...
        return ResponseEntity.ok(inviteMatchUseCase.invite(request.toCommand(signIn.userId())));
    }
