package com.official.lockr.domain.game.relay.domain;

import static com.official.lockr.domain.game.relay.domain.RelayEventType.FINISH;
import static com.official.lockr.domain.game.relay.domain.RelayEventType.START;
