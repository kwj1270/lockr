...
import com.official.lockr.domain.club.sqaud.domain.board.player.FieldPlayer;
import com.official.lockr.domain.club.sqaud.domain.board.player.Location;
...
public class FormationMatcher {
     ...
     */
    public static Map<String, Position> matchPlayersToFormation(final List<FieldPlayer> players, final Formation formation) {
        if (players.isEmpty()) {
    ...
    private static double calculateTotalDistance(final List<FieldPlayer> players, final Formation formation) {
        final Map<String, Position> matching = matchPlayersToFormation(players, formation);
