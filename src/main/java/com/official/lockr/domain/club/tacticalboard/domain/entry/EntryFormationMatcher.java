package com.official.lockr.domain.club.tacticalboard.domain.entry;

import com.official.lockr.global.vo.Formation;
import com.official.lockr.global.vo.Position;
import com.official.lockr.domain.club.tacticalboard.domain.entry.player.FieldPlayer;
import com.official.lockr.global.vo.Location;

import java.util.*;
import java.util.stream.Collectors;

public class EntryFormationMatcher {
     ...
     * @return 가장 적합한 포메이션
     */
    public static Formation inferFormation(final List<FieldPlayer> players, final Formation defaultFormation) {
        if (players.size() != 11) {
            return defaultFormation; // 기본 포메이션
        }
