...
public class SquadPlayer {
    ...
    private final SquadPlayerRole squadPlayerRole;
    ...
    public SquadPlayer(final String id,
                       ...
                       final SquadPlayerRole squadPlayerRole,
        ...
        this.squadPlayerRole = squadPlayerRole;
    ...
    public static SquadPlayer init(final String id, final String squadId, final String userId, final BackNumber backNumber) {
        return new SquadPlayer(
                id, squadId, userId, null, null, null, null, null, null, null, backNumber, SquadPlayerRole.BASIC,
    ...
    public SquadPlayerRole getPlayerRole() {
        return squadPlayerRole;
    }
