...
import com.official.lockr.domain.club.squad.domain.squad.RecruitmentInfo;
import com.official.lockr.domain.club.squad.domain.squad.RecruitmentInfos;
...
public class JOOQRecruitInfos implements RecruitmentInfos {
    ...
    @Nullable
    @Override
    public RecruitmentInfo find(final String teamId, final String userId) {
