...
public class SquadService implements AddSquadPlayerUseCase {
    ...
    public SquadService(final ApplicationRepository applicationRepository,
    ...
    public Squad addPlayer(final AddFootBallPlayerCommand command) {
        ...
        final SquadPlayer lineUpMember = squadPlayer(lineUp.getId(), command.userId(), application, backNumber);
