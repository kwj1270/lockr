...
public class Resume {
    ...
    public Resume(final String id, final String teamId, final String userId, final String birth, final String weight,
    ...
    public boolean isSameTeamId(final String teamId) {
        return this.teamId.equals(teamId);
    }


    public static Resume create(final String id, final String teamId, final String userId, final String birth, final String weight,
                                final String height, final String name, final String email, final String address, final String phone,
                                final String emergencyContactPhone, final String nationality, final List<Position> preferredPosition,
                                final Foot foot, final String advantages, final String disadvantages) {
        return new Resume(id, teamId, userId, birth, weight, height, name, email, address, phone, emergencyContactPhone, nationality, preferredPosition, foot, advantages, disadvantages, LocalDateTime.now(), null);
    }
